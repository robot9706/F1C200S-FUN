...
static boolean  using_text_startup = false;
...
// NOTE: For some reason loading voices.wad crashes the game
#if 0
...
static int introprogress = MAXINTROPROGRESS;        // track the progress of the intro
